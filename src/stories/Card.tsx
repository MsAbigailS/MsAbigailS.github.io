...
export const Card = ({
    ...
    return (
        ...
        <div className={`rounded-lg justify-center items-center flex flex-col min-w-75 min-h-92 max-w-75 max-h-92 p-1.5 m-2 `} style={{ backgroundColor: bgColor, color: txtColor, boxShadow: '0px 0px 0px rgba(255, 255, 255, 0.5)' }}>
            {/* upper half of card */}
            < div className={`flex flex-col w-full max-h-40 min-h-40`}>
                ...
                {/* visual/demo */}
                < div className={`flex flex-col justify-items-center min-h-32 max-h-32`}>
                    <div id="demoFrame" className={`rounded-sm flex-[1] m-1.5 text-center flex`}> {/* frame */}
            ...
            < div className={`flex flex-col w-full min-h-50 max-h-50`}>
                ...
                < div className={`flex-col min-h-42 max-h-42 items-center flex`}>
                    {/* description */}
                    < div className={`w-full flex-[2] min-w-0 overflow-hidden text-ellipsis text-sm`}>
                        {description}
                    </div >
                    {/* technologies */}
